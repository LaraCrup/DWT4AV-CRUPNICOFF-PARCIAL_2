...
@section('content')
    <section>
        <div class="sectionHeader">
            <h1 class="fontTitle">Administrar categorías</h1>
            <a href="{{ route('admin.categorias.create') }}" class="btn btnPrimary">Agregar categoría</a>
        </div>

        <div class="tableContainer tableCategories">
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    <a href="{{ route('admin.categorias.edit', $categoria->id) }}" class="btn btnPrimary">
                                    ...
                                    <button class="btn btnDelete deleteBtn" data-id="{{ $categoria->id }}" data-nombre="{{ $categoria->nombre }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24">
                                            <path fill="#f8f7ff"
